    ...
    private static final RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback()
    {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(()-> {
                ...
                keywordDAO.insert(new Keyword(27L, "wylamane"));
                keywordDAO.insert(new Keyword(28L, "konczyna"));
                keywordDAO.insert(new Keyword(29L, "konczyny"));
                keywordDAO.insert(new Keyword(30L, "wylamana"));
                keywordDAO.insert(new Keyword(31L, "wylamany"));
                keywordDAO.insert(new Keyword(32L, "noga"));
                keywordDAO.insert(new Keyword(33L, "nogi"));
                keywordDAO.insert(new Keyword(34L, "otwarte"));
                keywordDAO.insert(new Keyword(35L, "wystajaca"));
                keywordDAO.insert(new Keyword(36L, "nadgarstek"));
                keywordDAO.insert(new Keyword(37L, "zlamania"));
                keywordDAO.insert(new Keyword(38L, "wystaje"));
                ...
                keywordDAO.insert(new Keyword(43L, "zlamana"));
                keywordDAO.insert(new Keyword(44L, "zlamane"));
                keywordDAO.insert(new Keyword(45L, "przedramie"));
                keywordDAO.insert(new Keyword(46L, "zlamanie"));
